...
$(document).ready(function () {
  $(".quote-container").slick({
    ...
    // arrows: true,
    prevArrow:
      "<button type='button' class='slick-prev pull-left'><i class='fas fa-angle-left quote-icon' aria-hidden='true'></i></button>",
    nextArrow:
      "<button type='button' class='slick-next pull-right'><i class='fas fa-angle-right quote-icon' aria-hidden='true'></i></button>",
  });
});
